 ...
 */
public class ShoppingCart<T extends Comparable<T>> {
    // Here we declare a private field cartItems
    // of type List<SalableProduct<T>> to hold the items in the shopping cart.
    private List<SalableProduct<T>> cartItems;
     ...
     */
    public void addProduct(SalableProduct<T> product) {
     ...
     */
    public void removeProduct(SalableProduct<T> product) {
     ...
     */
    public SalableProduct<T> getProduct(int index) {
     ...
     */
    public List<SalableProduct<T>> returnCartContents() {
        return cartItems;
    }
